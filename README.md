...
* [Dapper](https://github.com/StackExchange/dapper-dot-net) - A simple object mapper for .NET by [StackExchange](http://stackexchange.github.io/)
...
* [RazorLight](https://github.com/toddams/RazorLight) - Templating engine based on Microsoft's Razor parsing engine with .NET Core support and ASP.NET MVC Core integrtion
